...
int memoizedLongestPalindromeLength(LengthMemo& memo, const std::string& str, int leftLimit, int rightLimit, timeUnit startTime, double maxDuration) {
  ...
  //
  //const IntPair pairKey = std::make_pair(leftLimit, rightLimit)
//  const IntPair left_pairKey = std::make_pair(leftLimit, rightLimit-1);
//  memo[left_pairKey] = leftSubproblemResult;
//  const IntPair right_pairKey = std::make_pair(leftLimit, rightLimit-1);
//  memo[right_pairKey] = rightSubproblemResult;
